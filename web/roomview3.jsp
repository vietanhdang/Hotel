                        ...
                        <div class="row">
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/44a.jpg);"></div>
                                    </div>
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/44b.jpg);"></div>
                                    </div>
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/44c.jpg);"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                                <h2 class="mb-4">Phòng Thượng Hạng</h2>
                                <p>Không gian toát lên sự quý tộc, đẳng cấp và cự c kì sang trọng.</p>
                                <div class="d-md-flex mt-5 mb-5">
                                    <ul class="list">
                                        <li><span>Tối đa:</span> 2 Người </li>
                                        <li><span>Diện tích:</span> 35 m2</li>
                                    </ul>
                                    <ul class="list ml-md-5">
                                        <li><span>Phong cảnh:</span> Hướng Đảo Ngọc</li>
                                        <li><span>Phòng tắm:</span> 1</li>
                                    </ul>
                                </div>
                                <p>Chúng ta chắc hẳn ai cũng có những cuộc gặp gỡ quan trọng, hay là cần một nơi nghỉ ngơi thật sự đẳng cấp. Thật hay Albert chúng tôi tạo ra những không gian quý phái, đáp ứng mọi nhu cầu, sự  tiện nghi của khách hàng.</p>
                            </div>
