                        ...
                        <div class="row">
                            <div class="col-md-12 ftco-animate">
                                <div class="single-slider owl-carousel">
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/22a.jpg);"></div>
                                    </div>
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/22b.jpg);"></div>
                                    </div>
                                    <div class="item">
                                        <div class="room-img" style="background-image: url(images/22c.jpg);"></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
                                <h2 class="mb-4">Phòng Gia Đình</h2>
                                <p>Nơi đây là không gian dành cho những gia đình cần sự  thư giãn, bối cảnh hài hòa, dễ chịu.</p>
                                <div class="d-md-flex mt-5 mb-5">
                                    <ul class="list">
                                        <li><span>Tối đa:</span> 6 Người </li>
                                        <li><span>Diện tích:</span> 60 m2</li>
                                    </ul>
                                    <ul class="list ml-md-5">
                                        <li><span>Phong cảnh:</span> Hướng vườn hoa</li>
                                        <li><span>Phòng tắm:</span> 2</li>
                                    </ul>
                                </div>
                                <p>Mỗi gia đình chúng ta chắc hẳn hầu hết sau mỗi ngày làm việc mệt mỏi thì luôn muốn tìm cho mình một chô xả căng thẳng, muộn phiền. Nơi đây chính là không gian dành cho gia đình bạn, nơi gắn kết tình yêu thương giữa vợ chồng và con cái. Đôi khi trong cuộc
                                    sống mình phải tạo cho bản thân những khoảnh khắc thật đáng nhớ.</p>
                            </div>
